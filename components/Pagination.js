...
export default function Pagination({ page }) {
  ...
  return (
    <div
      className="p-4 text-center grid-cols-4 gap-3.5 items-stretch justify-center mb-auto "
    ...
    >
      ...
      <div className=" inline-flex border rounded-lg divide-x xs:text-xs sm:text-sm md:text-md lg:text-lg xl:text-sm 2xl:text-xl">
